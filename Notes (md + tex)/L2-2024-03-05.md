...
L'**immagine** _(image o range)_ di una funzione è un **sottoinsieme del codominio**, composto da tutti i valori che la funzione può assumere. Ad esempio nella funzione $f : \mathbb{R} \rightarrow \mathbb{R}$ definita come $f(x) = x^2$, il codominio è $\mathbb{R}$ mentre l'immagine è $[0, +\infty)$.

La **controimmagine** _(preimage)_ di una funzione è l'**insieme di tutti gli elementi nel dominio** che vengono **mappati** a un particolare elemento nel codominio e viene indicata con $f^{-1}$.

![Funzione](assets/2024-03-05_1.png)
...
![Composizione di funzioni](assets/2024-03-05_2.png)
